...
public class Scheduling{
	...
	public JFrame frmSchedulingPanel;
	...
	JButton btnNewButton_13 = new JButton("Upgrade");
	...
	public Scheduling() {
		...
		lblNewLabel_6.setVisible(false);
			...
			btnNewButton_9.setBounds(90, 251, 238, 41);
			...
			btnNewButton_10.setBounds(333, 251, 55, 21);
					...
					try {
						...
						if (count == 1){
							...
							if("Manager".equals(ACC)){
								...
								lblNewLabel_6.setText("Welcome 'Manager'.");
								...
								btnNewButton_13.setVisible(false);
								lblNewLabel_6.setVisible(true);
								lblNewLabel_6.setText("Welcome 'Operator'.");
								...
								btnNewButton_13.setVisible(false);
								lblNewLabel_6.setVisible(true);
								lblNewLabel_6.setText("Welcome 'Instructor'.");
			...
			btnNewButton_13.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					...
					MembershipUI window = new MembershipUI();
					window.setVisible(true);
					refreshTable();
				
				}
			});
			btnNewButton_13.setBounds(90, 293, 238, 41);
			frmSchedulingPanel.getContentPane().add(btnNewButton_13);
			
			
			lblNewLabel_6.setBounds(37, 10, 291, 33);
			frmSchedulingPanel.getContentPane().add(lblNewLabel_6);
